...
public class XEditText extends AppCompatEditText {
    ...
    public XEditText(Context context, AttributeSet attrs) {
        this(context, attrs,R.attr.editTextStyle); // Attention here !
    }
    ...
    public XEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (disableEmoji) {
            ...
            newFilters[filters.length] = new EmojiExcludeFilter();
...
//            setFilters(new InputFilter[]{new EmojiExcludeFilter()});
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        boolean disableTogglePwdDrawable = a.getBoolean(R.styleable.XEditText_edittext_disableTogglePwdDrawable, false);

        if (!disableClear) {
            int cdId = a.getResourceId(R.styleable.XEditText_edittext_clearDrawable, -1);
            if (cdId == -1)
...
//            mMaxLength = 20;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (hasFocused && mBitmap != null && isPwdInputType && !isTextEmpty()) {
            ...
            int top = (getHeight() - getPaddingBottom() - getPaddingTop()) / 2 - mBitmap.getHeight() / 2;
            canvas.drawBitmap(mBitmap, left, top + getPaddingTop(), null);
        }
    }
     ...
     */
    public void setOnXTextChangeListener(OnTextChangeListener listener) {
